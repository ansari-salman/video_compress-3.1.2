...
```dart
final info = await VideoCompress.getMediaInfo(videopath,sourceType: "file"); /// file and network
...
| getMediaInfo      | String `path`[video path], String `sourceType`[file and network]                                                                                                                                                                                                                                                                                                                     | get media information from video `path`                                                          | `Future<MediaInfo>` |
